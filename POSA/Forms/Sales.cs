    ...
    public partial class Sales : Form
    {
        ...
        private void AddToGridWithBarcode(string barcode)
        {
            ...
            {//01246
                case "1":
                    dgvMain.Rows.Add();
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[0].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[1].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[2].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[4].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[6].Value = "1";

                    break;
                case "2":
                    dgvMain.Rows.Add();
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[0].Value = "2";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[1].Value = "2";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[2].Value = "2";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[4].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[6].Value = "2";
                    break;
                case "3":
                    dgvMain.Rows.Add();
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[0].Value = "3";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[1].Value = "3";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[2].Value = "3";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[4].Value = "1";
                    dgvMain.Rows[dgvMain.Rows.Count - 1].Cells[6].Value = "3";
                    break;
                default:
                    break;
            }
